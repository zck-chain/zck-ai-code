package com.zck.aicode.langgraph4j;

import cn.hutool.core.thread.ExecutorBuilder;
import cn.hutool.core.thread.ThreadFactoryBuilder;
import com.zck.aicode.exception.BusinessException;
import com.zck.aicode.exception.ErrorCode;
import com.zck.aicode.langgraph4j.model.QualityResult;
import com.zck.aicode.langgraph4j.node.*;
import com.zck.aicode.langgraph4j.node.concurrent.*;
...
public class CodeGenConcurrentWorkflow {
    ...
    public WorkflowContext executeWorkflow(String originalPrompt) {
        ...
        ThreadPoolExecutor pool = ExecutorBuilder.create()
                ...
                .setThreadFactory(ThreadFactoryBuilder.create().setNamePrefix("rallel-image-collect").build())
                .build();
        RunnableConfig runnableConfig = RunnableConfig.builder()
                .addParallelNodeExecutor("image_plan", pool).build();
